...
int main(int argc, char** argv) {
    ...
    pthread_t alloc_thread, even_filled, odd_filled, printer_thread, dealloc_thread;
    ...
    res = pthread_create(&even_filled, &attr, filler_thread_body, &TRUE);
    CHECK_RESULT(res);

    res = pthread_create(&odd_filled, &attr, filler_thread_body, &FALSE);
    CHECK_RESULT(res);
